...
function(add_ceph_make_check_test test_name test_path)
  ...
  set_property(TEST 
    ...
    CEPH_BIN=${CMAKE_BINARY_DIR}/bin
    CEPH_LIB=${CMAKE_BINARY_DIR}/lib
...
function(add_ceph_unittest unittest_name unittest_path)
  add_ceph_make_check_test(${unittest_name} ${unittest_path})
  target_link_libraries(${unittest_name} ${CMAKE_DL_LIBS} ${ALLOC_LIBS} ${UNITTEST_LIBS})
